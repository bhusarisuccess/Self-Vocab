...
fun HomeContent(paddingValues: PaddingValues) {
   ...
   val viewModel: DictionaryViewModel = hiltViewModel()
    ...
    DisposableEffect(Unit) {
        ...
        val intentFilter = IntentFilter("com.example.self_vocab.WORD_REFRESHED")
...
@Composable
fun TimeWordCard(viewModel: DictionaryViewModel) {
    val randomwords by viewModel.RandomWord.collectAsState()
